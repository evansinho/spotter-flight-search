      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={priceData} margin={{ top: 10, right: 10, left: 0, bottom: 20 }}>
          ...
          <XAxis
            ...
            label={{ value: `Price (${currency})`, position: 'bottom', offset: 0, style: { fill: '#6b7280', fontSize: 12 } }}
          />
          <YAxis
            tick={{ fill: '#6b7280', fontSize: 12 }}
            tickLine={{ stroke: '#e5e7eb' }}
            label={{ value: 'Number of Flights', angle: -90, position: 'insideLeft', style: { fill: '#6b7280', fontSize: 12 } }}
            allowDecimals={false}
          />
